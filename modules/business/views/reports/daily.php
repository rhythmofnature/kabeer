...
$this->title = Yii::t('app', 'Daily Business report');
	...
	<div class="col-md-3">	
        ...
        [
            'clientOptions' =>[
                    ...
                    'options'=>[
                    'class'=>'form-control',
                    'placeholder' => $model->getAttributeLabel('date_of_travel'),
                    'style'=>'width:200px',
...
<div class="col-md-4">
	...
	<div class="box-header with-border">
		<h3 class="box-title"><i class="fa fa-pie-chart"></i>Daily Business Report</h3>
	</div>
	<div class="box-body">
<?php
 if($report)
 {
  ...
  {
    $chart_business[] = array($data['product'],$data['quantity']);
  }
 }else 
 {
